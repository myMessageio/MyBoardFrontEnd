...
const SwitchNetworkModal = ({setIsOpenSwitchNetworkModal, postSort,switchNetwork,connectWallet,account, active, chainId,singleSelect, selectchainId}) => {  
    // useEffect(()=>{
    ...
    function selectNetwork(selectchainId){
        ...
        setIsOpenSwitchNetworkModal([false,false,'0']);
      if(!account){
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl ">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none ">
                ...
                <div className="flex justify-between items-center py-4 px-6 rounded-t border-b dark:border-gray-600 ">
                    ...
                    onClick={()=>{setIsOpenSwitchNetworkModal([false,false,'0'])}}
                    >
