...
import {modules} from "../../other/textEditorEnv"
        ...
        <li className="mb-3 ml-6 ">            
          ...
          <div className="relative w-full max-w-full flex-grow  flex-1 bg-blueGray-200 p-1 mb-1">
            ...
            <div className="flex flex-wrap mt-2 mb-2">    
              ...
              {account&&active ?(
                  <>
                    {(account.toLowerCase()!=commentInf.creator.toLowerCase())&&
                    ...
                    {(account.toLowerCase()!=commentInf.creator.toLowerCase())&&
                      <span className={statPercentColor + " mr-2"} >
                          ...
                          <i className="fas   fa-gift"></i> Your Awards  {commentOtherInf.userAwards}
                      </span>
                    }
                  </>
                  ):(<>
                    ...
                    <div className="relative w-full mb-3 border-1">                   
                      <div  className= "relative w-full mb-3"id="link1"  >            
                        <ReactQuill theme="snow"
                            ...
                            value={replydescription} onChange={setReplyDescription}
