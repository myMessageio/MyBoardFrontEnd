...
export default function  UserDetailInf({seluser, 
  active ,account,setIsOpenSwitchNetworkModal,chainId,selNetworks
  ...
  async function getdata(newselect,searchkey){
    ...
    var res=await backendPostRequest("user/userposts", formData);
